...
const errors: ClassifiedMessageMap = classifyMessageMap(constants.ERROR_TOKEN, {
  ...
  BAD_PLAY_LIST: (typeToken) => `Keyword 'play' expects a list of items of type 'instrn' generated by keyword 'make', but got a list of items of type ${typeToken} instead.`,
