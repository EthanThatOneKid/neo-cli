...
// make one that contains url globals

// Globals
const validKeywords = new Set(["~~", "await", "click", "depo", "eachpet", "endeach", "goto", "log", "login", "neo", "pause", "read", "rep", "rew", "sav", "savstat", "sel", "shoot", "swap", "title", "until", "var"]);
...
module.exports = class Neo {
    ...
    async var(config) {
        ...
        const data = dataType == "int" ? Number(data.replace(/\D/g, "")) : _data;
